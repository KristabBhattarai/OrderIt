...
module.exports = {
  ...
  alloweduserids: ["598524997954306048"], //Only allow specific Users to execute a Command [OPTIONAL]
      ...
      try{
        if (args[0]) {
          ...
          const embed = new MessageEmbed()
              ...
              .setDescription("**To see Order It main slash commands, Please use `/help`**")
